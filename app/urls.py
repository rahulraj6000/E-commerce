...
urlpatterns = [
    ...
    path('plus-minus-remove-cart/', views.plus_minus_remove_cart),
    ...
    path('password-reset/',
         auth_views.PasswordResetView.as_view(template_name='app/password_reset.html', form_class=PasswordResetForm), name="password_reset"),
